...
ACLOCAL = ${SHELL} '/home/ole/radio/missing' aclocal-1.18
ALL_LINGUAS = 
AMTAR = $${TAR-tar}
...
AUTOMAKE = ${SHELL} '/home/ole/radio/missing' automake-1.18
AWK = gawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
...
PACKAGE_STRING = gnome-radio 83.0.1
PACKAGE_TARNAME = gnome-radio
PACKAGE_URL = 
PACKAGE_VERSION = 83.0.1
PATH_SEPARATOR = :
