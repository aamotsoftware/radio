 ...
 * GNOME Radio
 *
 * Copyright (C) 2021, 2022, 2025, 2026  Aamot Research
 *
...
#endif
	gtk_window_set_title (GTK_WINDOW(window), _("Radio 79.0 - https://www.gnomeradio.org/ - https://wiki.gnome.org/Apps/Radio"));
